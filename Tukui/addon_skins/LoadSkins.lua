...
Mod_AddonSkins:SetScript("OnEvent",function(self, event, addon)
	...
	if TukuiCF["general"].omen and IsAddOnLoaded("Omen") then
		OmenTitle:SetPoint("TOPLEFT", Recount_MainWindow, "BOTTOMLEFT")
		OmenTitle:SetPoint("TOPRIGHT", Recount_MainWindow, "BOTTOMRIGHT")
		OmenBarList:SetPoint("BOTTOMLEFT",OmenTitle, "BOTTOMLEFT", 0 , TukuiDB.Scale(-100))
		OmenBarList:SetPoint("BOTTOMRIGHT",OmenTitle, "BOTTOMRIGHT", 0 , TukuiDB.Scale(-100))
	end
end)